  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='创新学分' prop="jifenNumber">
               <el-input v-model="ruleForm.jifenNumber"  placeholder='创新学分' clearable></el-input>
           </el-form-item>
         </el-col>
