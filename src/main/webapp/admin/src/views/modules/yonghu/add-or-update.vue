    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="创新学分" prop="jifenNumber">
                       <el-input v-model="ruleForm.jifenNumber"
                                 placeholder="创新学分" clearable  :readonly="ro.jifenNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="创新学分" prop="jifenNumber">
                           <el-input v-model="ruleForm.jifenNumber"
                                     placeholder="创新学分" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jifenNumber: [
                              { required: true, message: '创新学分不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
