        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="学科" prop="jifenjiluTypes">
                        <el-select v-model="ruleForm.jifenjiluTypes" :disabled="ro.jifenjiluTypes" placeholder="请选择学科">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学科" prop="jifenjiluValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩" prop="jifenjiluNumber">
                       <el-input v-model="ruleForm.jifenjiluNumber"
                                 placeholder="成绩" clearable  :readonly="ro.jifenjiluNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="成绩" prop="jifenjiluNumber">
                           <el-input v-model="ruleForm.jifenjiluNumber"
