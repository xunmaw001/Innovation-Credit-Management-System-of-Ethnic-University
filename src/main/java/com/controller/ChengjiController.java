    ...
    */
    ...
    public R save(@RequestBody ChengjiEntity chengji, HttpServletRequest request){
        ...
        Wrapper<ChengjiEntity> queryWrapper = new EntityWrapper<ChengjiEntity>()
            .eq("jifenjilu_name", chengji.getJifenjiluName())
            .eq("jifenjilu_types", chengji.getJifenjiluTypes())
            .eq("xueqi_types", chengji.getXueqiTypes())
            .eq("jifenjilu_number", chengji.getJifenjiluNumber())
...
//                            chengjiEntity.setJifenjiluName(data.get(0));                    //标题 要改的
//                            chengjiEntity.setJifenjiluTypes(Integer.valueOf(data.get(0)));   //学科 要改的
//                            chengjiEntity.setXueqiTypes(Integer.valueOf(data.get(0)));   //学期 要改的
//                            chengjiEntity.setJifenjiluNumber(Integer.valueOf(data.get(0)));   //成绩 要改的
//                            chengjiEntity.setYonghuId(Integer.valueOf(data.get(0)));   //学生 要改的
//                            chengjiEntity.setJifenjiluContent("");//详情和图片
