    ...
    */
    ...
    public R save(@RequestBody JifenjiluEntity jifenjilu, HttpServletRequest request){
        ...
        Wrapper<JifenjiluEntity> queryWrapper = new EntityWrapper<JifenjiluEntity>()
            ...
            .eq("xueqi_types", jifenjilu.getXueqiTypes())
...
//                            jifenjiluEntity.setXueqiTypes(Integer.valueOf(data.get(0)));   //学期 要改的
//                            jifenjiluEntity.setJifenjiluNumber(Integer.valueOf(data.get(0)));   //涉及学分数量 要改的
//                            jifenjiluEntity.setYonghuId(Integer.valueOf(data.get(0)));   //学生 要改的
//                            jifenjiluEntity.setJifenjiluContent("");//详情和图片
